...
class AffectationEnseignementResourceIT {
    ...
    private static final Integer DEFAULT_CHARGE_HORAIRE = 1;
    private static final Integer UPDATED_CHARGE_HORAIRE = 2;
     ...
     */
    public static AffectationEnseignement createEntity(EntityManager em) {
        AffectationEnseignement affectationEnseignement = new AffectationEnseignement()
            .anneeAcademique(DEFAULT_ANNEE_ACADEMIQUE)
            .chargeHoraire(DEFAULT_CHARGE_HORAIRE)
        ...
        affectationEnseignement.setEnseignant(enseignant);
     ...
     * if they test an entity which requires the current entity.
     */
    public static AffectationEnseignement createUpdatedEntity(EntityManager em) {
        AffectationEnseignement updatedAffectationEnseignement = new AffectationEnseignement()
            .anneeAcademique(UPDATED_ANNEE_ACADEMIQUE)
            .chargeHoraire(UPDATED_CHARGE_HORAIRE)
        ...
        updatedAffectationEnseignement.setEnseignant(enseignant);
        return updatedAffectationEnseignement;
    }

    @BeforeEach
    void initTest() {
        affectationEnseignement = createEntity(em);
    }
    ...
    @Test
    @Transactional
    void checkChargeHoraireIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        affectationEnseignement.setChargeHoraire(null);
    ...
    void getAllAffectationEnseignements() throws Exception {
        ...
        restAffectationEnseignementMockMvc
            ...
            .andExpect(jsonPath("$.[*].chargeHoraire").value(hasItem(DEFAULT_CHARGE_HORAIRE)))
    ...
    void getAffectationEnseignement() throws Exception {
        ...
        restAffectationEnseignementMockMvc
            ...
            .andExpect(jsonPath("$.chargeHoraire").value(DEFAULT_CHARGE_HORAIRE))
    ...
    void partialUpdateAffectationEnseignementWithPatch() throws Exception {
        ...
        partialUpdatedAffectationEnseignement.chargeHoraire(UPDATED_CHARGE_HORAIRE).coursId(UPDATED_COURS_ID);
