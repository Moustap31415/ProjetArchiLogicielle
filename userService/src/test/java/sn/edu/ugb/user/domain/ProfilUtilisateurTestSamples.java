...
public class ProfilUtilisateurTestSamples {
    ...
    public static ProfilUtilisateur getProfilUtilisateurSample1() {
        return new ProfilUtilisateur().id(1L).nom("nom1").prenom("prenom1").email("email1").telephone("telephone1");
    }

    public static ProfilUtilisateur getProfilUtilisateurSample2() {
        return new ProfilUtilisateur().id(2L).nom("nom2").prenom("prenom2").email("email2").telephone("telephone2");
    }
