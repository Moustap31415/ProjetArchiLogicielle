...
class ProfilUtilisateurResourceIT {
    ...
    public static ProfilUtilisateur createEntity(EntityManager em) {
        ...
        profilUtilisateur.setRole(role);
    ...
    public static ProfilUtilisateur createUpdatedEntity(EntityManager em) {
        ProfilUtilisateur updatedProfilUtilisateur = new ProfilUtilisateur()
            .nom(UPDATED_NOM)
        ...
        updatedProfilUtilisateur.setRole(role);
        return updatedProfilUtilisateur;
    }

    @BeforeEach
    void initTest() {
        profilUtilisateur = createEntity(em);
    }
    ...
    void putExistingProfilUtilisateur() throws Exception {
        ...
        updatedProfilUtilisateur.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).telephone(UPDATED_TELEPHONE);
    ...
    void fullUpdateProfilUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedProfilUtilisateur.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).telephone(UPDATED_TELEPHONE);
