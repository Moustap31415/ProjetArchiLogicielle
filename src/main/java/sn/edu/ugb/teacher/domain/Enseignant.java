...
public class Enseignant implements Serializable {
    ...
    public Set<AffectationEnseignement> getAffectations() {
        return this.affectations;
    }

    public void setAffectations(Set<AffectationEnseignement> affectationEnseignements) {
        if (this.affectations != null) {
            this.affectations.forEach(i -> i.setEnseignant(null));
        }
        if (affectationEnseignements != null) {
            affectationEnseignements.forEach(i -> i.setEnseignant(this));
        }
        this.affectations = affectationEnseignements;
    }

    public Enseignant affectations(Set<AffectationEnseignement> affectationEnseignements) {
        this.setAffectations(affectationEnseignements);
        return this;
    }

    public Enseignant addAffectations(AffectationEnseignement affectationEnseignement) {
        this.affectations.add(affectationEnseignement);
        affectationEnseignement.setEnseignant(this);
        return this;
    }

    public Enseignant removeAffectations(AffectationEnseignement affectationEnseignement) {
        this.affectations.remove(affectationEnseignement);
        affectationEnseignement.setEnseignant(null);
        return this;
    }
