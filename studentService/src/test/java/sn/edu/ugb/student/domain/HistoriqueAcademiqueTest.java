...
class HistoriqueAcademiqueTest {
    ...
    @Test
    void etudiantTest() {
        HistoriqueAcademique historiqueAcademique = getHistoriqueAcademiqueRandomSampleGenerator();
        Etudiant etudiantBack = getEtudiantRandomSampleGenerator();

        historiqueAcademique.setEtudiant(etudiantBack);
        assertThat(historiqueAcademique.getEtudiant()).isEqualTo(etudiantBack);

        historiqueAcademique.etudiant(null);
        assertThat(historiqueAcademique.getEtudiant()).isNull();
    }
}
