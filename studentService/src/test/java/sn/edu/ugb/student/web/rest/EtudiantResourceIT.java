...
class EtudiantResourceIT {
    ...
    private static final String DEFAULT_NUMERO_ETUDIANT = "P0";
    private static final String UPDATED_NUMERO_ETUDIANT = "P080712";
    ...
    void partialUpdateEtudiantWithPatch() throws Exception {
        ...
        partialUpdatedEtudiant.adresse(UPDATED_ADRESSE).utilisateurId(UPDATED_UTILISATEUR_ID);
