...
class HistoriqueAcademiqueResourceIT {
    ...
    public static HistoriqueAcademique createEntity(EntityManager em) {
        HistoriqueAcademique historiqueAcademique = new HistoriqueAcademique()
        ...
        historiqueAcademique.setEtudiant(etudiant);
    ...
    public static HistoriqueAcademique createUpdatedEntity(EntityManager em) {
        HistoriqueAcademique updatedHistoriqueAcademique = new HistoriqueAcademique()
        ...
        updatedHistoriqueAcademique.setEtudiant(etudiant);
        return updatedHistoriqueAcademique;
    }
    ...
    void putExistingHistoriqueAcademique() throws Exception {
        ...
        updatedHistoriqueAcademique.statut(UPDATED_STATUT).dateInscription(UPDATED_DATE_INSCRIPTION).semestreId(UPDATED_SEMESTRE_ID);
    ...
    void partialUpdateHistoriqueAcademiqueWithPatch() throws Exception {
        ...
        partialUpdatedHistoriqueAcademique.statut(UPDATED_STATUT).dateInscription(UPDATED_DATE_INSCRIPTION).semestreId(UPDATED_SEMESTRE_ID);
