...
class UniteEnseignementResourceIT {
    ...
    public static UniteEnseignement createEntity(EntityManager em) {
        ...
        uniteEnseignement.setFiliere(filiere);
    ...
    public static UniteEnseignement createUpdatedEntity(EntityManager em) {
        ...
        updatedUniteEnseignement.setFiliere(filiere);
    ...
    void putExistingUniteEnseignement() throws Exception {
        ...
        updatedUniteEnseignement.nom(UPDATED_NOM).code(UPDATED_CODE).credits(UPDATED_CREDITS).filiereId(UPDATED_FILIERE_ID);
    ...
    void partialUpdateUniteEnseignementWithPatch() throws Exception {
        ...
        partialUpdatedUniteEnseignement.filiereId(UPDATED_FILIERE_ID);
    ...
    void fullUpdateUniteEnseignementWithPatch() throws Exception {
        ...
        partialUpdatedUniteEnseignement.nom(UPDATED_NOM).code(UPDATED_CODE).credits(UPDATED_CREDITS).filiereId(UPDATED_FILIERE_ID);
