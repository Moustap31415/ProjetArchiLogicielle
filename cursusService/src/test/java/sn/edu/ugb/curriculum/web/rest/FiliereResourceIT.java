...
class FiliereResourceIT {
    ...
    private static final Integer DEFAULT_CREDITS_TOTAUX = 1;
    private static final Integer UPDATED_CREDITS_TOTAUX = 2;
    ...
    public static Filiere createEntity() {
        return new Filiere().nom(DEFAULT_NOM).code(DEFAULT_CODE).creditsTotaux(DEFAULT_CREDITS_TOTAUX);
    }
    ...
    public static Filiere createUpdatedEntity() {
        return new Filiere().nom(UPDATED_NOM).code(UPDATED_CODE).creditsTotaux(UPDATED_CREDITS_TOTAUX);
    }
    ...
    void getAllFilieres() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.[*].creditsTotaux").value(hasItem(DEFAULT_CREDITS_TOTAUX)));
    }
    ...
    void getFiliere() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.creditsTotaux").value(DEFAULT_CREDITS_TOTAUX));
    }
    ...
    void putExistingFiliere() throws Exception {
        ...
        updatedFiliere.nom(UPDATED_NOM).code(UPDATED_CODE).creditsTotaux(UPDATED_CREDITS_TOTAUX);
    ...
    void partialUpdateFiliereWithPatch() throws Exception {
        ...
        partialUpdatedFiliere.creditsTotaux(UPDATED_CREDITS_TOTAUX);
    ...
    void fullUpdateFiliereWithPatch() throws Exception {
        ...
        partialUpdatedFiliere.nom(UPDATED_NOM).code(UPDATED_CODE).creditsTotaux(UPDATED_CREDITS_TOTAUX);
