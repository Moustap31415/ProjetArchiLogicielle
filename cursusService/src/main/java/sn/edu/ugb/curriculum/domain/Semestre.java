...
public class Semestre implements Serializable {
    ...
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    @JsonIgnoreProperties(value = { "filiere", "unite", "semestre" }, allowSetters = true)
    ...
    public void setCurriculums(Set<Curriculum> curricula) {
        if (this.curriculums != null) {
            this.curriculums.forEach(i -> i.setSemestre(null));
        }
        if (curricula != null) {
    ...
    public Semestre curriculums(Set<Curriculum> curricula) {
        this.setCurriculums(curricula);
        return this;
    }

    public Semestre addCurriculums(Curriculum curriculum) {
        this.curriculums.add(curriculum);
        curriculum.setSemestre(this);
        return this;
    }

    public Semestre removeCurriculums(Curriculum curriculum) {
